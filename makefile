...
SRC_LIBS = \
	...
	$(SRC_DIR)/hg_marker.c \
	$(SRC_DIR)/hg_marker_move.c \
	$(SRC_DIR)/hg_viewport.c \
	$(SRC_DIR)/ut_utils.c \
	$(SRC_DIR)/ut_hex.c \
...
#
#   build/hg_common.o: src/hg_common.c src/hg_common.h src/hg_ncurses.h...
#	  gcc -c -o build/hg_common.o src/hg_common.c ...
#
